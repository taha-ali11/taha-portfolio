...
export const projects = [
  {
    ...
    purpose:
      "My own digital agency — built to earn trust, not just attention. A scroll-driven brand story. A bento services grid that makes decisions easy. And a contact flow that converts visitors into clients.",
  ...
  },
  {
    ...
    role: "Web Developer",
    purpose:
      "A freight and logistics site engineered to earn trust at first glance — clear service breakdowns, load times measured in milliseconds, and a quote flow built for dispatch teams who don't have seconds to waste.",
  ...
  },
  {
    ...
    role: "Web Designer",
    purpose:
      "A personal portfolio for Ali — clean case-study layout, zero distractions. His work is the hero. The template never steals the spotlight.",
    stack: ["Next.js", "Tailwind CSS", "Framer Motion"],
  ...
  },
  {
    ...
    purpose:
      "You're looking at it. A claymorphic, motion-first portfolio built to show — not just tell — how I fuse interface, animation, and performance into one seamless experience.",
