...
export const agencySocials = {
  ...
  instagram: "@_alphageeks_", // TODO: AlphaGeeks Instagram
...
export const coreSkills = [
  ...
  { name: "Node.js", icon: "nodejs", color: "coral" },
...
export const projects = [
  {
    ...
    purpose:
      "My own digital agency — built to win client trust with a scroll-driven brand story, a bento-style services grid, and a contact flow that actually converts.",
  ...
  {
    id: "ask4logistics",
    name: "American ASK4 Logistics",
    role: "Web Developer",
    purpose:
      "A freight & logistics company site engineered for trust at first glance — clear service breakdowns, fast load times, and a quote flow built for dispatch teams working under pressure.",
  ...
  },
  {
    ...
    role: "Web Developer",
    purpose:
      "A personal portfolio for a client named Ali — a clean case-study layout designed to make his work the hero, not the template.",
    stack: ["Next.js", "Tailwind CSS", "Framer Motion"],
  ...
  },
  {
    ...
    purpose:
      "The site you're on right now — a claymorphic, motion-first portfolio built to show exactly how I think about interface, animation, and performance together.",
