...
export const socials = {
  ...
  resume: "/public/resume-taha-ali.pdf",
};
...
export const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "Responsive Design", icon: "responsive", color: "sky" },
      { name: "Component Architecture", icon: "componentarch", color: "grape" },
      { name: "shadcn/ui", icon: "shadcn", color: "ink" },
      { name: "JSON", icon: "json", color: "sunny" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "API Design", icon: "apidesign", color: "coral" },
      { name: "Authentication", icon: "authentication", color: "sky" },
      { name: "Authorization", icon: "authorization", color: "teal" },
      { name: "Middleware", icon: "middleware", color: "grape" },
      { name: "Server Actions", icon: "serveractions", color: "green" },
    ],
  },
  {
    name: "State & Data",
    skills: [
      { name: "TanStack Query", icon: "tanstackquery", color: "coral" },
      { name: "React Context", icon: "reactcontext", color: "sky" },
      { name: "React Hooks", icon: "reacthooks", color: "grape" },
      { name: "Zustand", icon: "zustand", color: "ink" },
      { name: "Zod", icon: "zod", color: "teal" },
    ],
  },
  {
    name: "Testing & Quality",
    skills: [
      { name: "Jest", icon: "jest", color: "coral" },
      { name: "React Testing Library", icon: "rtl", color: "grape" },
      { name: "Playwright (E2E)", icon: "playwright", color: "green" },
    ],
  },
  {
    name: "Tooling & DevOps",
    skills: [
      ...
      { name: "CI/CD", icon: "cicd", color: "sky" },
      { name: "Vercel", icon: "vercel", color: "ink" },
      { name: "Docker", icon: "docker", color: "sky" },
      { name: "ESLint", icon: "eslint", color: "grape" },
      { name: "Prettier", icon: "prettier", color: "teal" },
      { name: "Husky", icon: "husky", color: "sunny" },
      { name: "lint-staged", icon: "lintstaged", color: "green" },
    ],
  },
  {
    name: "Automation & AI",
