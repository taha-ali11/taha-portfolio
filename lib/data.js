...
// "How I Build Software" — recruiter-facing engineering principles,
// replaces the old client-workflow "Four Steps" section.
...
export const engineeringCapabilities = [
  ...
  },
  {
    ...
    tech: ["Firebase", "Supabase", "PHP", "SQL", "Node.js"],
  },
  {
    icon: "uiEngineering",
  ...
  },
  {
    ...
    tech: ["TypeScript", "Cloud", "AI Integration", "n8n"],
  },
];

// Compact technology cloud beneath the capability cards — restored to the
// full previous skill list, each item keeping the color it had in the old
// category-grouped grid (grape/sky/sunny/teal/coral/clayGreen/ink), just
// flattened into this single wrapping pill layout instead of category blocks.
...
// "What I Deliver" — outcome checklist, sits below the Engineering Stack.
...
// Each project reads as an actual case study — problem, solution, outcome,
...
export const projects = [
  {
    ...
    problem:
      "Most agencies run their operations across 10+ separate platforms — one for CRM, another for project tracking, another for invoicing, another for documents — paying a subscription to each, with no single source of truth and constant context-switching between tools.",
    solution:
      "Designing and building AgencyOS as a unified operating system for agencies: one data model spanning CRM, projects, finance, and client workflows on Next.js, Prisma ORM, and PostgreSQL via Supabase, with the OpenAI API automating proposal drafting, email generation, and workflow summaries, and n8n powering self-hosted automation pipelines.",
    outcome:
      "Currently in active development as AlphaGeeks' internal operating system — the goal is to replace several separate paid tools with one platform once the CRM, finance, and workflow modules are complete.",
    features: [
      "Unified CRM, project, and finance data model",
      "AI-drafted proposals, emails, and workflow summaries via the OpenAI API",
      "Self-hosted automation pipelines with n8n",
